...
#BIAS CORRECTION #------------------------------------------------------------------------
##################
#Only modelle total co2 and ch4
...
#CONVERT TO POSITIVE#----------------------------------------------------------
#####################
#IN order to correctly calculate the realtive change I cant have negative values or it will reverse the variability
all_co2a[6]=all_co2a[6]*(-1)
all_co2a[10]=all_co2a[10]*(-1)
...
#co2
all_co2a_avg=avg_mod(all_co2a[1],all_co2a[4:])
...
##ch4 !!!!!!SCALED!!!!!!!
ch4a_rel=mean.mean_var(ch4_aam,all_ch4a_avg[1][0],ch4a_avg_s,mean='N',sp='CH4')
ch4b_rel=mean.mean_var(ch4_abm,all_ch4b_avg[1][0],ch4b_avg_s,mean='N',sp='CH4')
#co !!!!!!NOT SCALED!!!!!!!
...
#ch4
ax1=plt.subplot(121)
ax1=stack.stack_co2_NOB(lataam,co2a_rel[0],co2a_rel[1],co2a_rel[2][0],co2a_rel[2][1],co2a_rel[2][2],co2a_rel[2][3],co2a_rel[2][4],co2a_rel[2][5],co2a_rel[2][6],co2a_rel[2][7],co2a_rel[2][8],co2a_rel[2][9],co2a_rel[2][10],lab_col_co2,t='am',h='rel')
ax1.text(-43, 5.2, 'NB', fontsize=50) #7.8
ax1=plt.subplot(122)
ax1=stack.stack_co2_NOB(latabm,co2b_rel[0],co2b_rel[1],co2b_rel[2][0],co2b_rel[2][1],co2b_rel[2][2],co2b_rel[2][3],co2b_rel[2][4],co2b_rel[2][5],co2b_rel[2][6],co2b_rel[2][7],co2b_rel[2][8],co2b_rel[2][9],co2b_rel[2][10],lab_col_co2,t='bm',h='rel')
...
def pie(sizes,lc,sp):
    ...
    for i in range(len(lc)):
        col.append(lc[i][1])
    ax1.pie(sizes,colors=col[2:], autopct='%1.1f%%',pctdistance=0.8, textprops=dict(fontsize=20,color='white'))
    ax1.axis('equal')
...
ax=pie_nobackg(sizes1a,lab_col_co2,sp='CO2')    
ax=pie_nobackg(sizes1b,lab_col_co2,sp='CO2')       

...
def stack_ch4(lata,ch4_meas,ch4_tota, ch4_oga,ch4_cma,ch4_lsa,ch4_waa,ch4_bfa,ch4_ria,ch4_ana,ch4_bba,ch4_wea,ch4_saa,ch4_nata,lc,t,h):
    ...
    plt.bar(lata, ch4_bba,  width, color=lc[9][1],  align='center', label=lc[9][0],  bottom=ch4_oga+ch4_cma)
    plt.bar(lata, ch4_waa,  width, color=lc[5][1],  align='center', label=lc[5][0],  bottom=ch4_oga+ch4_cma+ch4_bba)
    #plt.bar(lata, ch4_bfa,  width, color=lc[6][1], align='center', label='lc[6][0], bottom=ch4_oga+ch4_cma+ch4_bba+ch4_waa)
    plt.bar(lata, ch4_lsa,  width, color=lc[4][1],  align='center', label=lc[4][0],  bottom=ch4_oga+ch4_cma+ch4_bba+ch4_waa)
    #plt.bar(lata, ch4_ana,  width, color=lc[8][1], align='center', label=lc[8][0],  bottom=ch4_oga+ch4_cma+ch4_bba+ch4_waa+ch4_lsa)
    plt.bar(lata, ch4_ria,  width, color=lc[7][1],  align='center', label=lc[7][0],  bottom=ch4_oga+ch4_cma+ch4_bba+ch4_waa+ch4_lsa)     
    plt.bar(lata, ch4_nata, width, color=lc[12][1], align='center', label=lc[12][0], bottom=ch4_oga+ch4_cma+ch4_bba+ch4_waa+ch4_lsa+ch4_ria)        
    plt.bar(lata, ch4_wea,  width, color=lc[10][1], align='center', label=lc[10][0], bottom=ch4_oga+ch4_cma+ch4_bba+ch4_waa+ch4_lsa+ch4_ria+ch4_nata)
    #SINKS+
...
def stack_co2(lata,co2_meas,co2_tota, co2_ffa,co2_oca,co2_bala,co2_bba,co2_bfa,co2_ntea,co2_sea,co2_ava,co2_cha,co2_corra,co2_bckg,lc,t,h):
    ...
    plt.bar(lata, co2_bckg, width, color=lc[12][1], align='center', label=lc[12][0],  bottom=co2_ffa+co2_bfa+co2_bba)    
    #plt.bar(lata, co2_corra,width, color=lc[11][1],align='center', label=lc[11][0], bottom=co2_ffa+co2_bfa+co2_bba)
    #plt.bar(lata, co2_cha,  width, color=lc[10][1],align='center', label=lc[10][0], bottom=co2_ffa+co2_bfa+co2_bba)   
    #SINKS
    plt.bar(lata, co2_oca*(-1),  width, color=lc[3][1],align='center',label=lc[3][0])
    plt.bar(lata, co2_ntea*(-1), width, color=lc[7][1],align='center',label=lc[7][0], bottom=co2_oca*(-1))
    #sink and source
    plt.bar(np.nan,np.nan, width, color=lc[4][1], align='center',     label=lc[4][0])
    for i in range(len(co2_bala)):
        if co2_bala[i]>0:
            plt.bar(lata[i], co2_bala[i], width, color=lc[4][1],align='center',       bottom=co2_ffa[i]+co2_bfa[i]+co2_bba[i]+co2_bckg[i])
        else:
            plt.bar(lata[i], co2_bala[i], width, color=lc[4][1],align='center',       bottom=co2_oca[i]*(-1)+co2_ntea[i]*(-1))
    if t=='bm':
        plt.legend() 
    if h=='rel':
        plt.ylim(-3,6)
...
def stack_co(lata,co_meas, co_tota,co_ausa,co_afra,co_sama,co_otha,co_bbsama,co_bbafa,co_bbnhasa,co_bbausa,\
    ...
    plt.bar(lata, co_afra,  width, color=lc[3][1],  align='center', label=lc[3][0],  bottom=co_ausa) 
    plt.bar(lata, co_sama,  width, color=lc[4][1],  align='center', label=lc[4][0],  bottom=co_ausa+co_afra)
    plt.bar(lata, co_otha,  width, color=lc[5][1],  align='center', label=lc[5][0],  bottom=co_ausa+co_afra+co_sama)
    plt.bar(lata, co_bbausa,width, color=lc[9][1],  align='center', label=lc[9][0],  bottom=co_ausa+co_afra+co_sama+co_otha)
    plt.bar(lata, co_bbafa, width, color=lc[7][1],  align='center', label=lc[7][0],  bottom=co_ausa+co_afra+co_sama+co_otha+co_bbausa)
    plt.bar(lata, co_bbsama,width, color=lc[6][1],  align='center', label=lc[6][0],  bottom=co_ausa+co_afra+co_sama+co_otha+co_bbausa+co_bbafa)   
    #plt.bar(lata, co_bbnhasa,width,color=lc[8][1], align='center', label=lc[8][0],  bottom=co_ausa+co_afra+co_sama+co_otha+co_bbausa+co_bbafa+co_bbsama)
    #plt.bar(lata, co_bbindoa,width,color=lc[10][1],align='center', label=lc[10][0], bottom=co_ausa+co_afra+co_sama+co_otha+co_bbausa+co_bbafa+co_bbsama+co_bbnhasa)
    plt.bar(lata, co_bbotha,width, color=lc[11][1], align='center', label=lc[11][0], bottom=co_ausa+co_afra+co_sama+co_otha+co_bbausa+co_bbafa+co_bbsama)
    plt.bar(lata, co_ch4a,  width, color=lc[12][1], align='center', label=lc[12][0], bottom=co_ausa+co_afra+co_sama+co_otha+co_bbausa+co_bbafa+co_bbsama+co_bbotha)
    plt.bar(lata, co_nmvoc,  width,color=lc[13][1], align='center', label=lc[13][0], bottom=co_ausa+co_afra+co_sama+co_otha+co_bbausa+co_bbafa+co_bbsama+co_bbotha+co_ch4a)
    #ax.set_xticks(lata)

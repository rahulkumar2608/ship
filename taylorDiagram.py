...
class TaylorDiagram(object):
    ...
    def __init__(self, refstd, fig=None, r1=1,r2=1,r3=1, label='_', srange=(0, 1.5)):
        """
        ...
        * srange: stddev axis extension, in units of *refstd*
        ...
        ax = FA.FloatingSubplot(fig, r1,r2,r3, grid_helper=ghelper) #r1 r2 r3 are the subplot numbers
        fig.add_subplot(ax)
        ...
        ax.axis["left"].label.set_text("Enhancement")
